...
//  EmployeeRoster
//
//  Created by Colin Erickson on 11/8/23.
//
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "employeeList", for: indexPath)
...
//    func employeeTypeTableViewController(_ controller: EmployeeListTableViewController, didSelect employeeType: EmployeeType) {
//        self.employeeType = employeeType
//    }
