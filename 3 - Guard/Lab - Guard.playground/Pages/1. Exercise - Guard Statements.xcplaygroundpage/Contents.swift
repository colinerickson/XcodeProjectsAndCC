...
calculateArea(x: 88.8, y: 99.7)
calculateArea(x: 22, y: 0)
...
func createUser() -> User? {
    ...
    let user = User(firstName: "Colin", lastName: "Erickson", age: "17")
    return user
}
...
if let user = createUser() {
    print("Hello, \(user.firstName) \(user.lastName) you are \(user.age) years old.")
}
